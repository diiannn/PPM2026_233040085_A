...
class ApiClient {
  ...
  // static const String _apiKey  = 'API_KEy_123'; //tes
  ...
  Future<http.Response> _send(Future<http.Response> Function() req) async {
    try {
      ...
      // Paksa ubah teks agar PERSIS sesuai perintah tugas
      if (res.statusCode == 401) {
        throw ApiException(401, 'HTTP 401: API key tidak valid.');
      } else if (res.statusCode == 422) {
        throw ApiException(422, 'HTTP 422');
      }
      ...
      throw ApiException(0, 'Terjadi kesalahan: Tidak ada koneksi internet.');
    }
  }
